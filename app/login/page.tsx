        ...
        <div className="flex flex-col gap-6">
          <Input icon={<Envelope />} label="Email address" labelFor="mail">
            <input
              ...
              className={`text-[1rem] text-dark-grey leading-[1.5rem] bg-transparent w-full py-3 px-4 rounded-lg border-[1px] border-light-silver focus:border-han-purple outline-none focus:shadow-light pl-10 ${
                errors?.mail && "border-coral-red shadow-none"
              }`}
              type="email"
              id="mail"
          ...
          <Input labelFor="password" icon={<Lock />} label="Password">
            <input
              {...register("password", {
                required: "Can't be empty",
              ...
              className={`text-[1rem] text-dark-grey leading-[1.5rem] bg-transparent w-full py-3 px-4 rounded-lg border-[1px] border-light-silver outline-none focus:border-han-purple focus:shadow-light pl-10 ${
                errors?.password && "border-coral-red shadow-none"
              }`}
              type="password"
              id="password"
